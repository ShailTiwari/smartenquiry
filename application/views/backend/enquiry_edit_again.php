                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading">Enquiry Save As</div>
                         ...
                         <form id="enquiry_add" method="post">                              
                                ...
                                <div class="col-sm-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          <label for="exampleInputuname">Quantity_2</label>
                                          <div class="input-group col-md-12 col-sm-12 col-xs-12">
                                      ...
                                      <div class="form-group">
                                          <label for="exampleInputuname">Quantity_3</label>
                                          <div class="input-group col-md-12 col-sm-12 col-xs-12">
                                      ...
                                      <div class="form-group">
                                          <label for="exampleInputuname">Quantity_4</label>
                                          <div class="input-group col-md-12 col-sm-12 col-xs-12">
                                      ...
                                      <div class="form-group">
                                          <label for="exampleInputuname">Quantity_5</label>
                                          <div class="input-group col-md-12 col-sm-12 col-xs-12">

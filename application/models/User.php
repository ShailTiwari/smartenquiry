...
Class User extends CI_Model 
{
    ...
    function login($username, $password) {
        ...
        $query = $this->db->query("SELECT UserId,UserName,UserPassword as UserPass,Post as PersonPost,MgtLevels as MgtLevel FROM usermaster 
            WHERE  UserLoginName='$username' AND  UserPassword='$password' LIMIT 1");

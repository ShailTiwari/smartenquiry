function txt_searchmachine1() {
    var term1 = $("#txt_searchmachine1").val();
...
function info1(val){
    ...
    if(hdn_baseprid == 'FC' || hdn_baseprid == 'FL' || hdn_baseprid == 'WP' || hdn_baseprid == 'Pack' || hdn_baseprid == 'FF' || hdn_baseprid == 'Pa' || hdn_baseprid == 'PN'){
        $('#tbody_options').html('');
         startSpinner();
        ...
        $.ajax({
            ...
            if (main!= false) {
                if(prid == "") {
                    $('#thead_option').html('');
                    $("#thead_option").append("<tr><td colspan='11'>\n\
                        <label style='font-size:11px;'>Search</label>\n\
                        <input type='text' name='txt_searchmachine1' id='txt_searchmachine1' onkeydown='txt_searchmachine1();' style='width: 50%; height: 18px; font-size:10px;'></td>\n\
                    </tr><tr>\n\
                        <th align='center' style ='font-size: 10px; border: 1px solid #212121; background-color: #627aac; color: #FFFFFF;'>Options</th>\n\
                    </tr>");
                    for (var i = 0; i < main.length; i++) {
                        $('#tbody_options').append("<tr onclick='return optionset("+k+")'>\n\
                            <td><input type='hidden' value='other' id='hdn_pridhdn'>\n\
                                <input type='hidden' name='hdn_spid"+k+"' id='hdn_spid"+k+"' value='"+main[i].SPID+"'>\n\
                                <label id='lbl_description"+k+"'>"+main[i].Description +"</label></td>\n\
                        </tr>");
                        k++;
                    }
                } else {
                    ...
                    $("#thead_option").append("<tr><td colspan='11'>\n\
                        <label style='font-size:11px;'>Search</label>\n\
                        <input type='text' name='txt_searchmachine1' id='txt_searchmachine1' onkeydown='txt_searchmachine1();' style='width: 50%; height: 21px; font-size:11px;'></td>\n\
                    </tr><tr>\n\
                        <th align='center' style='width: 7%;'>Die ID</th>\n\
                        <th align='center' style='width: 10%;'>Die No</th>\n\
                        <th align='center' style='width: 17%;'>Die Type</th>\n\
                        <th align='center' style='width: 7%;'>Length</th>\n\
                        <th align='center' style='width: 7%;'>Breadth</th>\n\
                        <th align='center' style='width: 7%;'>Height</th>\n\
                        <th align='center' style='width: 4%;'>Ups</th>\n\
                        <th align='center' style='width: 22%;'>Remarks</th>\n\
                        <th align='center' style='width: 5%;'>PF</th>\n\
                        <th align='center' style='width: 5%;'>TF</th>\n\
                        <th align='center' style='width: 7%;'>BottomF</th>\n\
                    </tr>");
                    for (var i = 0; i < main.length; i++) {
                        $('#tbody_options').append("<tr onclick='return optionset("+k+")'>\n\
                            <td><input type='hidden' value='PN' id='hdn_pridhdn'>\n\
                                <input type='hidden' name='hdn_dieid"+k+"' id='hdn_dieid"+k+"' value='"+main[i].dieID+"'>\n\
                                <label id='lbl_dieid"+k+"'>"+main[i].dieID +"</label></td>\n\
                            <td><input type='hidden' name='hdn_dieno"+k+"' id='hdn_dieno"+k+"' value='"+main[i].Dieno+"'>\n\
                                <label id='lbl_dieno"+k+"'>"+main[i].Dieno +"</label></td>\n\
                            <td><label id='lbl_dietype"+k+"'>"+main[i].DieType +"</label></td>\n\
                            <td><label id='lbl_length"+k+"'>"+main[i].Length +"</label></td>\n\
                            <td><label id='lbl_breadth"+k+"'>"+main[i].Breadth +"</label></td>\n\
                            <td><label id='lbl_height"+k+"'>"+main[i].Height +"</label></td>\n\
                            <td><label id='lbl_ups"+k+"'>"+main[i].Ups +"</label></td>\n\
                            <td><label id='lbl_remarks"+k+"'>"+main[i].Remarks +"</label></td>\n\
                            <td><label id='lbl_pf"+k+"'>"+main[i].PF +"</label></td>\n\
                            <td><label id='lbl_tftf"+k+"'>"+main[i].TF +"</label></td>\n\
                            <td><label id='lbl_bottomf"+k+"'>"+main[i].BottomF +"</label></td>\n\
                        </tr>");
                        k++;
                    }
                }
            } else {
                $('#tbody_options').append("<tr><td>Data not available</td></tr>");
            }
...
function optionset(val){
    ...
    if($("#hdn_pridhdn").val() == "other") {
        ...
        var id_var1 = $('#hdn_id_var').val();
        var dieid = $('#hdn_dieid'+val).val();
        var dienoo = $('#hdn_dieno'+val).val();
        var dieno = "Die No. :"+dienoo;
        $("input[type='hidden'][name='hdn_info3["+ id_var1 +"\\]']").val(dieno);        
        $("#lbl_info3"+ id_var1).text(dieno);
        $("input[type='hidden'][name='hdn_var_id_info1["+ id_var1 +"\\]']").val(dieid);     
    }
}
...
function showcorrugation(rel){
        ...
        $.ajax({
             ...
             $('#myModaldocid').modal({backdrop: 'static', keyboard: false});
